...
- Запуск бота командой:         ./ebotSpotLS-8.0g 
...
- перенесите в эту папку файл бота ebotSpotLS-8.0g (или скачайте с github командой: wget https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-8.0g/ebotSpotLS-8.0g)
- откройте screen-сессию (например:    screen -S ebotSpot   )
- дайте права запуска файлу (команда:    chmod 755 ebotSpotLS-8.0g   )
- запустите E-Bot (команда:    ebotSpotLS-8.0g   )
