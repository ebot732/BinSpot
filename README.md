...
- Запуск бота командой:         ./ebotSpot-8.7
...
Здесь E-Bot представлен для ознакомления и использования в течении пробного периода до 15 февраля 2023 г.
...
- перенесите в эту папку файл бота ebotSpot-8.7 (или скачайте с github командой: wget https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-8.7/ebotSpot-8.7)
- откройте screen-сессию (например:    screen -S ebotSpot   )
- дайте права запуска файлу (команда:    chmod 755 ebotSpot-8.7   )
- запустите E-Bot (команда:    ./ebotSpot-8.7   )
...
Для удобства настройки E-Bot можно использовать прогу tgUpravSpot8 (https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-8.7/tgUpravSpot8). Для этого нужно добавить ее в папку, где работает Е-Bot и запустить (./tgupravSpot8) в отдельном SCREEN. Необходимые данные прога возьмет из БД E-Bot и будет управляться через чат telegram-Bot.
