...
BinSpot выбирает монету, выросшую (или упавшую, при работе в SHORT) за выбранный в настройках период времени на delta_start процентов- сравнивает текущую цену и цену открытия самой дальней выбранной свечи, и с объемом торгов, увеличившимся больше, чем на delta_vol_start процентов, 
...
- super_auto: режим удержания подходящей по параметрам пары в super_asset,   
- delta_stop: процент изменения цены для автооткл super_auto и возврата после закрытия позиции в перебор монет,   
- time_stop_sa: время действия режима super_auto после старта в минутах,   
...
- перенесите в эту папку файл бота BinSpot-21 (или скачайте с github командой: wget https://github.com/ebot732/BinSpot/releases/download/BinSpot-21/BinSpot-21)
- откройте screen-сессию (например:    screen -S BinSpot   )
- дайте права запуска файлу (команда:    chmod 755 BinSpot-21   )
- запустите BinSpot (команда:    ./BinSpot-21  )
