...
- Запуск бота командой:         ./ebotSpot-7.7g 
...
- перенесите в эту папку файл бота ebotSpot-7.7g (или скачайте с github командой: wget https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-7.7g/ebotSpot-7.7g)
- откройте screen-сессию (например:    screen -S ebotSpot   )
- дайте права запуска файлу (команда:    chmod 755 ebotSpot-7.7g   )
- запустите E-Bot (команда:    ./ebotSpot-7.7g   )
