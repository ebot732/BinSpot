...
- quoteVolume24hr: мнимальный 24-х часовой объем торгов в квотируемой валюте (в паре ETH/USDT это USDT, в паре ETH/BTC это BTC), чтобы бот взял пару из white_list в работу.
