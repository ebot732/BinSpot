...
- перенесите в эту папку файл бота BinSpot-19 (или скачайте с github командой: wget https://github.com/ebot732/BinSpot/releases/download/BinSpot-19/BinSpot-19)
- откройте screen-сессию (например:    screen -S BinSpot   )
- дайте права запуска файлу (команда:    chmod 755 BinSpot-19   )
- запустите BinSpot (команда:    ./BinSpot-19  )
