...
- перенесите в эту папку файл бота BinSpot-16 (или скачайте с github командой: https://github.com/ebot732/BinSpot/releases/download/BinSpot-16/BinSpot-16)
- откройте screen-сессию (например:    screen -S BinSpot   )
- дайте права запуска файлу (команда:    chmod 755 BinSpot-16   )
- запустите E-Bot (команда:    ./BinSpot-16  )
