...
- Запуск бота командой:         ./ebotSpot-8.3
...
- step_aver1, step_aver2, ... step_aver7: ввод шагов изменения цены для выставления усредов,
...
- перенесите в эту папку файл бота ebotSpot-8.3 (или скачайте с github командой: wget https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-8.3/ebotSpot-8.3)
- откройте screen-сессию (например:    screen -S ebotSpot   )
- дайте права запуска файлу (команда:    chmod 755 ebotSpot-8.3   )
- запустите E-Bot (команда:    ebotSpot-8.3   )
