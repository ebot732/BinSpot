...
Для удобства настройки E-Bot можно использовать tgupravSpot3. Для этого нужно добавить его в папку, где работает Е-Bot и запустить в отдельном SCREEN. Данные он возмет из БД E-Bot и будет управляться через telegram-Bot.
Скриншоты
