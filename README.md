...
- перенесите в эту папку файл бота ebotSpot-8.5 (или скачайте с github командой: wget https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-8.6/ebotSpot-8.6)
