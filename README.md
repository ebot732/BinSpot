...
- Запуск бота командой:         ./ebotSpot-8.6
...
- перенесите в эту папку файл бота ebotSpot-8.6 (или скачайте с github командой: wget https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-8.6/ebotSpot-8.6)
- откройте screen-сессию (например:    screen -S ebotSpot   )
- дайте права запуска файлу (команда:    chmod 755 ebotSpot-8.6   )
- запустите E-Bot (команда:    ./ebotSpot-8.6   )
...
Для удобства настройки E-Bot можно использовать прогу tgUpravSpot8 (https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-8.6/tgUpravSpot8). Для этого нужно добавить ее в папку, где работает Е-Bot и запустить (./tgupravSpot8) в отдельном SCREEN. Необходимые данные прога возьмет из БД E-Bot и будет управляться через чат telegram-Bot.
