...
- перенесите в эту папку файл бота BinSpot-18 (или скачайте с github командой: https://github.com/ebot732/BinSpot/releases/download/BinSpot-18/BinSpot-18)
- откройте screen-сессию (например:    screen -S BinSpot   )
- дайте права запуска файлу (команда:    chmod 755 BinSpot-18   )
- запустите BinSpot (команда:    ./BinSpot-18  )
