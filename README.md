...
- Запуск бота командой:         ./ebotSpot-7.5g 
...
Здесь E-Bot представлен для ознакомления и использования в течении пробного периода до Dec 01 2022 GMT+0000
...
- перенесите в эту папку файл бота ebotSpot-7g (или скачайте с github командой: wget https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-7.5g/ebotSpot-7.5g)
- откройте screen-сессию (например:    screen -S ebotSpot   )
- дайте права запуска файла (команда:    chmod 755 ebotSpot-7.5g   )
- запустите E-Bot (команда:    ./ebotSpot-7.5g   )
...
Для удобства настройки E-Bot можно использовать прогу tgUpravSpot4. Для этого нужно добавить ее в папку, где работает Е-Bot и запустить (./tgupravSpot4) в отдельном SCREEN. Данные прога возьмет из БД E-Bot и будет управляться через чат telegram-Bot.
