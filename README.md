...
- перенесите в эту папку файл бота BinSpot-12 (или скачайте с github командой: https://github.com/ebot732/BinSpot/releases/download/BinSpot-12/BinSpot-12)
- откройте screen-сессию (например:    screen -S BinSpot   )
- дайте права запуска файлу (команда:    chmod 755 BinSpot-12   )
- запустите E-Bot (команда:    ./BinSpot-12   )
