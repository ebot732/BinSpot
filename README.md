...
После закрытия каждой сделки BinBot:
...
- min_order: минимальная покупка в котируемой валюте (например, в паре ETH/USDT это USDT, ставить больше 11),
...
Здесь BinSpot представлен для ознакомления и использования в течении пробного периода до 01 авг 2023 г.
...
- перенесите в эту папку файл бота BinSpot-14 (или скачайте с github командой: https://github.com/ebot732/BinSpot/releases/download/BinSpot-14/BinSpot-14)
- откройте screen-сессию (например:    screen -S BinSpot   )
- дайте права запуска файлу (команда:    chmod 755 BinSpot-14   )
- запустите E-Bot (команда:    ./BinSpot-14  )
...
Для удобства настройки BinSpot используется телеграм бот, которого нужно сделать админом в телеграм канале. Необходимые данные телеграм бот возьмет из БД BinSpot и будет управляться через чат telegram-Botа.
