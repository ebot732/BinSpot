...
- активы должны быть в базовой валюте (в паре ETH/USDT это ETH)?
- min_order: также как и в LONG, указываем в квотируемой валюте (например, в паре ETH/USDT это USDT, ставить больше 11),
