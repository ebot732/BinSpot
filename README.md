...
- Запуск бота командой:         ./ebotSpot-7.1g 
...
- перенесите в эту папку файл бота ebotSpot-7g (или скачайте с github командой: wget https://github.com/ebot732/ebotSpot/releases/download/ebotSpot-7.1g/ebotSpot-7.1g)
- откройте screen-сессию (например:    screen -S ebotSpot   )
- дайте права запуска файла (команда:    chmod 755 ebotSpot-7.1g   )
- запустите E-Bot (команда:    ./ebotSpot-7.1g   )
...
Для удобства настройки E-Bot можно использовать tgupravSpot3. Для этого нужно добавить его в папку, где работает Е-Bot и запустить (./tgupravSpot3) в отдельном SCREEN. Данные он возьмет из БД E-Bot и будет управляться через чат telegram-Bot-а.
