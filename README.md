...
BinSpot выбирает монету, выросшую за выбранный в настройках период времени на delta_start процентов- сравнивает текущую цену и цену открытия самой дальней выбранной свечи, и с объемом торгов, увеличившимся больше, чем на delta_vol_start процентов, 
